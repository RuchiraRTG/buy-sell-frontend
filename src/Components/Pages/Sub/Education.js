...
const educationData = [
  {
    ...
    price: 149,
    image: "https://via.placeholder.com/220x220?text=Python+Course",
    location: "Colombo",
    condition: "Digital",
    brand: "Tech Academy",
  },
  {
    id: 2,
    name: "Business English Grammar Book",
    category: "Books",
    price: 35,
    image: "https://via.placeholder.com/220x220?text=English+Book",
    location: "Kandy",
    condition: "New",
    brand: "Oxford",
  },
  {
    id: 3,
    name: "Biology Lab Equipment Set",
    category: "Lab Equipment",
    price: 280,
    image: "https://via.placeholder.com/220x220?text=Lab+Set",
    location: "Galle",
    condition: "Brand New",
    brand: "Science Pro",
  },
  {
    ...
    price: 199,
    image: "https://via.placeholder.com/220x220?text=Marketing+Cert",
    location: "Colombo",
    condition: "Digital",
    brand: "Digital Experts",
  },
  {
    id: 5,
    name: "Mathematics Practice Books (Set of 5)",
    category: "Books",
    price: 85,
    image: "https://via.placeholder.com/220x220?text=Math+Books",
    location: "Negombo",
    condition: "Brand New",
    brand: "Education Plus",
  },
  {
    id: 6,
    ...
    category: "Online Courses",
    price: 399,
    image: "https://via.placeholder.com/220x220?text=Web+Dev+Course",
    location: "Colombo",
    condition: "Digital",
    brand: "Code Academy",
  },
...
function Education() {
  ...
  const toggleWishlist = (item) => {
    const wishlistId = `education-${item.id}`;
    const payload = {
      id: wishlistId,
      title: item.name,
      price: item.price,
        ...
        <div className="accessories-content">
          <div className="header-section">
            ...
            <p className="page-subtitle">
              Shop books, courses, and learning resources
            </p>
                ...
                <div key={item.id} className="accessory-card">
                  ...
                  <div className="accessory-info">
                    ...
                    <div className="card-footer">
                      ...
                      <button
                        className={`wishlist-icon-btn ${isWishlisted(`education-${item.id}`) ? "active" : ""}`}
                        onClick={(e) => {
                          e.stopPropagation();
                          toggleWishlist(item);
                        }}
